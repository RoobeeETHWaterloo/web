...
const items = [
  'We build CRYPTOBRAWL using Skale - a side-chain solution. Now you won’t pay tons of money for gas if you want to play more in a fast operating side-chain environment',
  'CRYPTOBRAWL is all about cooperation. You can meet and fight almost any of the ERC721 Token',
  'We don’t store your ERC721. You get access to the functionality using MetaMask or Torus',
  'It’s not about just fun. We empower NFT/ERC721 community',
]
